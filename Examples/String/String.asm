...
0000000000001149 <main>:
    ...
    1164:	48 c7 45 ee 61 62 63 	mov    QWORD PTR [rbp-0x12],0x64636261
    116b:	64 
    116c:	66 c7 45 f6 00 00    	mov    WORD PTR [rbp-0xa],0x0
    1172:	b8 00 00 00 00       	mov    eax,0x0
    1177:	48 8b 55 f8          	mov    rdx,QWORD PTR [rbp-0x8]
    117b:	64 48 33 14 25 28 00 	xor    rdx,QWORD PTR fs:0x28
    1182:	00 00 
    1184:	74 05                	je     118b <main+0x42>
    1186:	e8 c5 fe ff ff       	call   1050 <__stack_chk_fail@plt>
    118b:	c9                   	leave  
    118c:	c3                   	ret    
