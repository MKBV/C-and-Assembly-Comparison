...
0000000000001060 <_start>:
    ...
    1071:	50                   	push   rax
    1072:	54                   	push   rsp
    1073:	4c 8d 05 96 01 00 00 	lea    r8,[rip+0x196]        # 1210 <__libc_csu_fini>
    107a:	48 8d 0d 1f 01 00 00 	lea    rcx,[rip+0x11f]        # 11a0 <__libc_csu_init>
...
0000000000001149 <main>:
    ...
    115c:	c7 45 f8 01 00 00 00 	mov    DWORD PTR [rbp-0x8],0x1
    ...
    1179:	8b 55 f4             	mov    edx,DWORD PTR [rbp-0xc]
    117c:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
    117f:	01 d0                	add    eax,edx
    1181:	89 45 fc             	mov    DWORD PTR [rbp-0x4],eax
    1184:	8b 45 f8             	mov    eax,DWORD PTR [rbp-0x8]
    1187:	89 45 f4             	mov    DWORD PTR [rbp-0xc],eax
    118a:	8b 45 fc             	mov    eax,DWORD PTR [rbp-0x4]
    118d:	89 45 f8             	mov    DWORD PTR [rbp-0x8],eax
    1190:	81 7d f4 fe 00 00 00 	cmp    DWORD PTR [rbp-0xc],0xfe
    1197:	7e ca                	jle    1163 <main+0x1a>
    1199:	eb ba                	jmp    1155 <main+0xc>
    119b:	0f 1f 44 00 00       	nop    DWORD PTR [rax+rax*1+0x0]

00000000000011a0 <__libc_csu_init>:
    11a0:	f3 0f 1e fa          	endbr64 
    11a4:	41 57                	push   r15
    11a6:	4c 8d 3d 0b 2c 00 00 	lea    r15,[rip+0x2c0b]        # 3db8 <__frame_dummy_init_array_entry>
    11ad:	41 56                	push   r14
    11af:	49 89 d6             	mov    r14,rdx
    11b2:	41 55                	push   r13
    11b4:	49 89 f5             	mov    r13,rsi
    11b7:	41 54                	push   r12
    11b9:	41 89 fc             	mov    r12d,edi
    11bc:	55                   	push   rbp
    11bd:	48 8d 2d fc 2b 00 00 	lea    rbp,[rip+0x2bfc]        # 3dc0 <__do_global_dtors_aux_fini_array_entry>
    11c4:	53                   	push   rbx
    11c5:	4c 29 fd             	sub    rbp,r15
    11c8:	48 83 ec 08          	sub    rsp,0x8
    11cc:	e8 2f fe ff ff       	call   1000 <_init>
    11d1:	48 c1 fd 03          	sar    rbp,0x3
    11d5:	74 1f                	je     11f6 <__libc_csu_init+0x56>
    11d7:	31 db                	xor    ebx,ebx
    11d9:	0f 1f 80 00 00 00 00 	nop    DWORD PTR [rax+0x0]
    11e0:	4c 89 f2             	mov    rdx,r14
    11e3:	4c 89 ee             	mov    rsi,r13
    11e6:	44 89 e7             	mov    edi,r12d
    11e9:	41 ff 14 df          	call   QWORD PTR [r15+rbx*8]
    11ed:	48 83 c3 01          	add    rbx,0x1
    11f1:	48 39 dd             	cmp    rbp,rbx
    11f4:	75 ea                	jne    11e0 <__libc_csu_init+0x40>
    11f6:	48 83 c4 08          	add    rsp,0x8
    11fa:	5b                   	pop    rbx
    11fb:	5d                   	pop    rbp
    11fc:	41 5c                	pop    r12
    11fe:	41 5d                	pop    r13
    ...
    1202:	41 5f                	pop    r15
    1204:	c3                   	ret    
    1205:	66 66 2e 0f 1f 84 00 	data16 nop WORD PTR cs:[rax+rax*1+0x0]
    120c:	00 00 00 00 
